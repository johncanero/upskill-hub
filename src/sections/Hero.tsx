    ...
    <div className=''>
      <div>
        <div className='mx-6 md:mx-12 lg:mx-0 lg:ml-64'>
          <h1 className='mt-12 text-4xl font-bold text-gray-900 dark:text-gray-100 md:mt-32 md:max-w-sm lg:max-w-2xl md:text-4xl lg:text-7xl font-OpenSans'>Maximize skill, minimize budget</h1>
