...
const Header = () => {
  ...
  return (
    <div>
      <div className="hidden py-4 shadow-sm bg-gray-50 lg:block lg:px-64 dark:bg-gray-900 shadow-gray-200 dark:shadow-gray-800">
        <header className="flex items-center justify-between h-16 mt-1">
          ...
          {/* Pages */}
          <div className="z-10">
            <ul className="flex gap-8 mt-2 text-sm lg:text-base font-OpenSans">
              <Link
                rel="noopener noreferrer"
                href="/"
